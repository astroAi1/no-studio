const PROGRAMS = [
  ...
  { id: "echo", label: "Echo", familyBias: "chrome", reductionBias: "lock", ditherBias: "diffuse", useActiveBgChance: 0.4, intensityBand: "mid" },
  ...
  { id: "afterimage", label: "Afterimage", familyBias: "chrome", reductionBias: "mask", ditherBias: "cluster", useActiveBgChance: 0.25, intensityBand: "mid" },
];
